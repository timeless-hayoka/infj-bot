...
class SelfModification:
    ...
    def assess_interaction(self, user_input: str, bot_output: str, emotion: Optional[Dict] = None,
        ...
        # Usefulness: did it address what Jude brought?
    ...
    def extract_lesson(self, user_input: str, bot_output: str, assessment: Dict) -> Optional[Dict]:
        ...
        if lowest_score > 0.7:
            ...
            if random.random() < 0.3:
                lesson = f"When I am {max(scores, key=scores.get)}, Jude responds well."
            ...
            lesson_templates = {
                ...
                "depth": "I stayed on the surface. Jude needed me to go deeper.",
                ...
                "usefulness": "I did not give Jude what he needed. I should ask what would help.",
