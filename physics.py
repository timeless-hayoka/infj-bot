...
its own weight, momentum, and connection to Jude.
...
class PhysicsState:
    ...
    resonance: float = 0.0  # harmonic match with Jude's current state (-1 to 1)
...
class PhysicsEngine:
    ...
    - resonance: am I vibrating with or against Jude right now?
    ...
    def observe_interaction(self, emotion_label: str, intensity: float,
        ...
        # Resonance: match between Jude's stated emotion and bot's felt response
