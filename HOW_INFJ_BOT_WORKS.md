...
9. **Background**: an async **consciousness loop** runs phased **plugin cycles** (heartbeat of the architecture) independent of idle chat gaps.
...
| File | Purpose |
|------|---------|
| `README.md` | Quick start, slash commands cheat sheet links |
| `SECURITY.md` | Secret hygiene & reporting posture |
| `DRIFT_AI_INTEGRATION.md` | How seeded Drift concepts map into memory-only integration |
| `DELL_HANDOFF.md` | Longer ops notes (devices, backups, quirks) |
