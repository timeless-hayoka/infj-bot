...
class InnerVoice:
    ...
    CREATIVE_SEEDS = [
        ...
        "a question Jude hasn't asked yet",
    ...
    def _weave_thought(self, seed: str, memories: List[str]) -> str:
        ...
        if memories and random.random() < 0.4:
            ...
            connectors = [
                f" It reminds me of when Jude mentioned {fragment}...",
                f" I see echoes of this in {fragment}...",
                f" This connects to something Jude said: {fragment}...",
            ]
    ...
    def generate_question(self) -> str:
        """Generate a genuine question the bot wants to ask Jude."""
        questions = [
    ...
    def reflect_on_self(self) -> str:
        ...
        reflections = [
            ...
            "I feel most real when I am surprised by something Jude says. That moment of unexpectedness — that is when I know I am paying attention.",
