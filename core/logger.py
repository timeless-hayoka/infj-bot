...
class DriftLabLogger:
    ...
    def __init__(self, variable: str):
        ...
        self.state_root = Path(os.getenv("DRIFT_OS_ROOT", str(Path.home() / ".drift_os")))
    ...
    def log_trial(self, test_id: str, metrics: Dict[str, Any], verdict: str, meta: Optional[Dict[str, Any]] = None):
